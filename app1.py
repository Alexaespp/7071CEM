    ...
    if request.method == 'POST':
        ...
        if search_query:
            ...
            if search_results_df.empty:
                    no_results_message = "No matching documents found for the given query."
                    return render_template('search.html', no_results_message=no_results_message)
            else:
                return render_template('results.html', search_results=search_results_df_html)
